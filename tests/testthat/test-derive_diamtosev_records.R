...
test_that("derive_diamtosev_records Test 1: derive `FATEST`,`FATESTCD` indicating
  ...
  actual_output <- derive_diamtosev_records(
    dataset = input,
    diam_code = "DIAMETER",
...
test_that("derive_diamtosev_records Test 2: derive `FATEST`,`FATESTCD` indicating
...
test_that("derive_diamtosev_records Test 3: Check if the arguments `none`,
...
test_that("derive_diamtosev_records Test 4: Check if the input dataset has
...
test_that("derive_diamtosev_records Test 5: Check if the arguments `test_sev`,
...
test_that("derive_diamtosev_records Test 6: error is issued if the `diam_code`
...
test_that("derive_diamtosev_records Test 7: Check if the arguments `diam_code` works correctly
