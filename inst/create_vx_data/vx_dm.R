...
dm <- tribble(~USUBJID,~SUBJID,~RFSTDTC,~RFENDTC,~RFXSTDTC,~RFXENDTC,~RFICDTC,~RFPENDTC, ~SITEID, ~INVID, ~INVNAM, ~BRTHDTC, ~AGE, ~AGEU, ~SEX, ~RACE, ~ETHNIC,
             ...
             "ABC-1002","1002","2021-10-07T12:48:00","2022-06-14","2021-10-07T12:48:00","2021-12-16T12:41:00","2021-09-22","2022-06-14",1002,1212,"Gomez, Selena","1951-07-13",70,"YEARS","F","BLACK OR AFRICAN AMERICAN","HISPANIC OR LATINO") %>%
  mutate(
STUDYID = "ABC",
DOMAIN = "DM",
