...
vx_ce <- ce_t %>%
  ...
  unite(CELNKID, CETPTREF, CELOC, CELAT, CETERM, sep = "-", na.rm = TRUE, remove = FALSE) %>%
  # ordering the variables
  select(
    STUDYID, DOMAIN, USUBJID, CESEQ, CELNKID, CELNKGRP, CETERM, CEDECOD, CELAT, CELOC, CECAT,
    CESCAT, CEPRESP, CEOCCUR, CESEV, CEREL, CEOUT, EPOCH, CEDTC, CESTDTC, CEENDTC, CEDUR, CETPT,
    CETPTNUM, CETPTREF, CERFTDTC, CEEVINTX, CESTAT, CEREASND
  )
