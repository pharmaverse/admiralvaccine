...
```
# Creating ANL01FL which would flag the records that will be considered for analysis and if there
is investigator and subject record for a same day, it would flag the Investigator record over the
subject record.
Note: Please, consider which assessment is needed for your analysis. If you want to prioritize
