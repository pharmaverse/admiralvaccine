...
-   [Derive direct mapping varibles](#mapping)
...
```{r echo=FALSE}
face <- face %>% filter(FACAT == 'REACTOGENICITY' & grepl('ADMIN|SYS',FASCAT)) %>%  mutate(FAOBJ = str_to_sentence(FAOBJ))
...
The function `derive_vars_event_flag` is used to derive flag varible for the event occurred.
