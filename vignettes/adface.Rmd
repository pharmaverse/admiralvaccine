...
In this step, we will derive maximum records for severity, diameter, temperature  events using the function `derive_extreme_records()`.
...
adface <- derive_extreme_records(
  ...
  order = exprs(AVAL),
  mode = "last",
  set_values_to = exprs(FATEST = "Maximum Severity",
                        FATESTCD = "MAXSEV")
)
...
adface <- derive_extreme_records(
  ...
  order = exprs(AVAL),
  mode = "last",
  set_values_to = exprs(FATEST = "Maximum Diameter",
                        FATESTCD = "MAXDIAM")
)
...
adface <-   derive_extreme_records(
  ...
  mode = "last",
  set_values_to = exprs(FATEST = "Maximum Temperature",
                        FATESTCD = "MAXTEMP")
)
```

This call returns the input dataset with maximum records added for an event `FEVER`.
