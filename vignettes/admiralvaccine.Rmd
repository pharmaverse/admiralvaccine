...
The most important functions in `{admiralvaccine}` follow the same
conventions as `{admiral}` but are focused to vaccine-specific needs. Please
refer the Reference Page for more details.
